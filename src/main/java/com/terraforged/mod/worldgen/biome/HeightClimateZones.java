...
public final class HeightClimateZones {
    /** Above this → Alpine climate regardless of lowland climate/terrain. */
    public static final float ALPINE_HEIGHT = 0.70F;
    /** Same band: no trees. */
    public static final float TREELINE_HEIGHT = ALPINE_HEIGHT;
