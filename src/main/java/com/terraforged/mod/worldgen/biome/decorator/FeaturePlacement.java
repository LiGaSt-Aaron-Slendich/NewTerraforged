...
public final class FeaturePlacement {
    ...
    public static boolean place(PlacedFeature placed, WorldGenLevel level, ChunkGenerator generator, RandomSource random, BlockPos pos, boolean modBiome) {
        if (!modBiome) {
            try {
    ...
    public static boolean place(Holder<PlacedFeature> holder, WorldGenLevel level, ChunkGenerator generator, RandomSource random, BlockPos pos, boolean modBiome) {
        if (!modBiome) {
            try {
    ...
    private static boolean placeUnwrapped(PlacedFeature placed, WorldGenLevel level, ChunkGenerator generator, RandomSource random, BlockPos pos) {
        try {
