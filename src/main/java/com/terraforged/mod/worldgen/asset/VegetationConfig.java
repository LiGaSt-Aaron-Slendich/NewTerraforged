...
public class VegetationConfig implements ContextSeedable<VegetationConfig> {
   ...
   public static final Codec<VegetationConfig> CODEC = LazyCodec.record(
      instance -> instance.group(
            Codec.FLOAT.optionalFieldOf("frequency", 1.0F).forGetter(VegetationConfig::frequency),
            Codec.FLOAT.optionalFieldOf("jitter", 1.0F).forGetter(VegetationConfig::jitter),
            Codec.FLOAT.optionalFieldOf("density", 1.0F).forGetter(VegetationConfig::density),
   ...
   public String toString() {
      return "VegetationConfig{frequency="
         + this.frequency
         + ", jitter="
         + this.jitter
         + ", density="
