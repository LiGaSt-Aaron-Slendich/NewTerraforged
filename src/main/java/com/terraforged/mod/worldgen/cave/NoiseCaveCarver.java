...
public class NoiseCaveCarver {
    ...
    /** Rounded mega/giga volume тАФ avoids cubic column stacks and flat terrace ceilings. */
    ...
    /** 3├Ч3 smooth on elevation + cavern radius тАФ stops per-column cubic stacks in mega/giga. */
