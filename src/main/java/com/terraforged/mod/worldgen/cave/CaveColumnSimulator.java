...
public final class CaveColumnSimulator {
    ...
    public static Sample sampleMegaGiga(Generator generator, NoiseCave config, int seed, Module modifier, int x, int z) {
        return CaveColumnSimulator.sampleMegaGiga(generator, config, seed, modifier, x, z, 3);
    }
    ...
    public static Sample sampleMegaGigaForCartography(Generator generator, NoiseCave config, int seed, Module modifier, int x, int z) {
        return CaveColumnSimulator.sampleMegaGiga(generator, config, seed, modifier, x, z, 1);
    }

    private static Sample sampleMegaGiga(Generator generator, NoiseCave config, int seed, Module modifier, int x, int z, int minCavern) {
        ...
        int nominalY = config.getHeight(x, z);
