...
public final class CaveMegaAccentDecorator {
        ...
        for (lx = 1; lx < 16; lx += 7) {
            for (lz = 1; lz < 16; lz += 6) {
                ...
                if (volcanic || scorching) {
                    ...
                    FeaturePlacement.place(large, region, (ChunkGenerator)generator, random, new BlockPos(wx, floorY, wz), true);
                }
                if (cold && frostColumns != null && !ice && random.nextFloat() < 0.32f) {
                    random.setFeatureSeed(seed, 10, 0);
                    FeaturePlacement.place(frostColumns, region, (ChunkGenerator)generator, random, new BlockPos(wx, floorY, wz), true);
                }
                ...
                if (ice && random.nextFloat() < 0.55f) {
                    ...
                    FeaturePlacement.place(iceCrystal, region, (ChunkGenerator)generator, random, new BlockPos(wx, ceilY, wz), true);
                    ...
                    FeaturePlacement.place(large, region, (ChunkGenerator)generator, random, new BlockPos(wx, ceilY, wz), true);
                    ...
                    FeaturePlacement.place(dripCluster, region, (ChunkGenerator)generator, random, new BlockPos(wx, ceilY, wz), true);
                }
                if (vines != null && random.nextFloat() < 0.28f && CaveMegaAccentDecorator.mayPlace(chunk, carver, lx, vineY = ceilY - random.nextInt(3), lz, generator, wx, wz, biome)) {
                    ...
                    FeaturePlacement.place(vines, region, (ChunkGenerator)generator, random, new BlockPos(wx, vineY, wz), true);
                }
                ...
                FeaturePlacement.place(lichen, region, (ChunkGenerator)generator, random, new BlockPos(wx, midY, wz), true);
            }
        }
        for (lx = 1; lx < 16; lx += 4) {
            for (lz = 1; lz < 16; lz += 4) {
    ...
    private static void placeFirstMatch(Registry<PlacedFeature> registry, ResourceLocation[] ids, WorldGenLevel region, Generator generator, WorldgenRandom random, int wx, int y, int wz, long seed, int seedBase, int stage) {
        for (int i = 0; i < ids.length; ++i) {
            ...
            if (!FeaturePlacement.place(feature, region, (ChunkGenerator)generator, random, new BlockPos(wx, y, wz), true)) continue;
            return;
        }
    }
