...
public final class CaveFeatureFilters {
    ...
    public static boolean belongsToModCaveBiome(Holder<PlacedFeature> placed, Holder<Biome> biome) {
        ...
        // Same-namespace datapack cave features — require cave-ish path tokens (not bare "lush").
        if (fNs.equals(bNs) && ("terralith".equals(bNs) || "biomesoplenty".equals(bNs) || "regions_unexplored".equals(bNs)
            ...
            if (fPath.contains("cave/") || fPath.contains("/cave") || fPath.contains("grotto") || fPath.contains("glowshroom")
                    ...
                    || fPath.contains("dripstone") || fPath.contains("lush_caves") || fPath.contains("mycel")
    ...
    public static boolean isModCaveFeatureAllowed(Holder<PlacedFeature> placed, Holder<Biome> biome) {
        ...
        return !CaveFeatureClassifier.spawnsSurfaceVegetation(placed);
    }
