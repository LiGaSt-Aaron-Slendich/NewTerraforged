...
import com.terraforged.mod.compat.legacy.BiomeDictionary;
import com.terraforged.mod.compat.legacy.BiomeDictionary.Type;
...
public final class CaveBiomeIds {
    ...
    public static boolean isNetherThemedBiome(Holder<Biome> biome) {
        ...
        return BiomeCategory.NONE == BiomeCategory.NETHER;
    }
